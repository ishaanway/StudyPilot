  ...
  window.StudyPilotDashboard = {
    ...
    renderAISuggestions: function () {
      ...
      if (hasScienceExamSoon && uncompletedTasks.some(t => t.subject === "Science")) {
        html = `
          <p>Your <strong>CBSE Science Exam (Curiosity Ch 1-3)</strong> is in <strong>3 days</strong>! You still have the Electricity summary task incomplete. I suggest revising Ch 3 components now.</p>
        ...
        html = `
          <p>Outstanding! Your daily academic schedule is perfectly optimized and all tasks are completed. Use the <strong>AI Tutor chat</strong> if you want to explore new CBSE Grade 7 chapters!</p>
          <div class="ai-tip-actions">
